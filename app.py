...
class TwilioWebhookHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        bot_response = chat_with_ai(incoming_msg, website_text, pdf_text, chat_history)
        
        # Store chat history in the global variable
        chat_history.append({"user": incoming_msg, "bot": bot_response})
